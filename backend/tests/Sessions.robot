...
*Variables*
&{inv_pass}       email=kelvinpaz@gmail.com    password=abc123
&{inv_email}      email=kelvinpaz&gmail.com    password=abc123
&{email_404}      email=kelvinpz@gmail.com     password=abc123
&{empty_email}    email=${EMPTY}               password=abc123
&{wo_email}       password=abc123
&{empty_pass}     email=kelvinpaz@gmail.com    password=${EMPTY}
&{wo_pass}        email=kelvinpaz@gmail.com    
